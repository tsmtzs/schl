...
\item \leavevmode\\
  ...
  \item Να αποδείξετε ότι η εξίσωση ($*$) παριστάνει τις ευθείες\points{5}
...
\remark{\textit{Όλες οι απαντήσεις να γραφούν στην κόλλα σας.}}


\vspace{7ex}

\signatures{Μπάμπης Χαρχαρούχας}
\hfill
\signatures[Οι Εισηγητές]{Μαριλού Διαβητοπούλου,Σάκης Παραβολάκης}
\end{document}
